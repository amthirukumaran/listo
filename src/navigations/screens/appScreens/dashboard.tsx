...
import { firebase, getAuth, signInWithCustomToken, signOut } from "@react-native-firebase/auth";
import { Keyboard, KeyboardAvoidingView, ScrollView, Text, TouchableOpacity, View, Modal, ActivityIndicator, StatusBar } from "react-native";
...
export default function Dashboard() {
    ...
    const handleLoginthisAccount = async (currentUid: string) => {
        ...
        ListoAPI?.get(`/custom-token?uid=${currentUid}`).then((listoResponse: any) => {
            ...
            signInWithCustomToken(firebase.auth(), listoResponse?.data?.token).then(customTokenResponse => {
                let currentUser: any;
